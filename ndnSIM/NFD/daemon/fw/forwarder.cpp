...
//  LogManager::AddLog("forwarder.cpp->onIncomingInterest.6");
  ...
  if (!isPending) {
    if (m_csFromNdnSim == nullptr) {
    	...
    	LogManager::AddLogWithNodeId("forwarder.cpp->onIncomingInterest.m_cs.searchTime", std::to_string(duration));
    }
    else {
    	chrono::high_resolution_clock::time_point t1 = chrono::high_resolution_clock::now();
		...
		chrono::high_resolution_clock::time_point t2 = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::microseconds>( t2 - t1 ).count();
		LogManager::AddLogWithNodeId("forwarder.cpp->onIncomingInterest.m_csFromNdnSim.searchTime", std::to_string(duration));
...
Forwarder::onIncomingData(Face& inFace, const Data& data)
{
  ...
  if (m_csFromNdnSim == nullptr){
	  ...
	  chrono::high_resolution_clock::time_point t2 = chrono::high_resolution_clock::now();
	  auto duration = chrono::duration_cast<chrono::microseconds>( t2 - t1 ).count();
	  LogManager::AddLogWithNodeId("forwarder.cpp->onIncomingData.m_cs.insertionTime", std::to_string(duration));
  }
  else {
	  chrono::high_resolution_clock::time_point t1 = chrono::high_resolution_clock::now();
	  ...
	  chrono::high_resolution_clock::time_point t2 = chrono::high_resolution_clock::now();
	  auto duration = chrono::duration_cast<chrono::microseconds>( t2 - t1 ).count();
	  LogManager::AddLogWithNodeId("forwarder.cpp->onIncomingData.m_csFromNdnSim.insertionTime", std::to_string(duration));
  }
